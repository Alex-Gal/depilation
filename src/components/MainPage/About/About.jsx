                ...
                <div className="about_block">
                    <div className='about__text'>
                        <ScrollAnimation offset={50} delay={100} animateIn='fadeIn'>
                            <h2 className='about__text_title'>О себе</h2>
                        </ScrollAnimation>
                        <ScrollAnimation offset={20} delay={100} animateIn='fadeIn'>
                            <hr className='about__text_line' />
                        </ScrollAnimation>

                        <ul className='about__text_list'>
                            <ScrollAnimation offset={20} delay={200} animateIn='bounceInLeft'>
